...
src_prepare() {
	...
	epatch	"${FILESDIR}"/cores_Makefile-${PV}.patch
...
src_install() {
	...
	if use java; then
		...
		#  /usr/share/${P}/hardware/libraries does not exist for arduino-0018
		#  subdirecotories of former /usr/share/${P}/hardware/libraries are now
		#  stored under /usr/share/${P}/libraries
	fi
